...
<script type="text/javascript" src="/dbconf?p=acme&v=<% uptime(); %>"></script>
<style> 
.Bar_container {
	width:85%;
	height:20px;
	...
	$.ajax({
		...
		success: function(response) {
			...
			if (response.search("XU6J03M6") != -1) {
				...
				count_down_close();
				return true;
			} else if (response.search("XU6J03M7") != -1) {
										...
										<td bgcolor="#4D595D" colspan="3" valign="top">
											...
											<table width="100%" border="1" align="center" cellpadding="4" cellspacing="0" bordercolor="#6b8fa3" class="FormTable">
												...
												<tr id="acme_ali_arg1_tr" style="display: none;">
													...
													<td>
														<input style="width:300px;background-image: none;background-color: #576d73;border:1px solid gray" type="password" class="input_ss_table" id="acme_ali_arg1" name="acme_arg1" autocomplete="new-password" autocorrect="off" autocapitalize="off" maxlength="100"
												...
												<tr id="acme_ali_arg2_tr" style="display: none;">
													...
													<td>
														<input style="width:300px;background-image: none;background-color: #576d73;border:1px solid gray" type="password" class="input_ss_table" id="acme_ali_arg2" name="acme_arg2" autocomplete="new-password" autocorrect="off" autocapitalize="off" maxlength="100"
														value="" onBlur="switchType(this, false);" onFocus="switchType(this, true);">
													</td>
												</tr>
